                  ...
                  {socialLinks.map((s, i) => {
                    ...
                    return (
                      <a
                        ...
                        aria-label={icon?.label ?? s.platform}
                        className="w-[35px] h-[35px] rounded-full bg-[#3f3e3e] hover:bg-brand-teal text-white flex items-center justify-center transition-colors duration-150"
                      >
                        {icon ? (
                          <span
